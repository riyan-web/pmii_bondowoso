...
<head>
    ...
    <link rel="stylesheet" href="assets/backend/vendors/jqvmap/dist/jqvmap.min.css">
...
<body>
                    ...
                    <div class="header-left">
                        ...
                        <div class="dropdown for-message">
                            ...
                            <div class="dropdown-menu" aria-labelledby="message">
                                ...
                                <a class="dropdown-item media bg-flat-color-1" href="#">
                                    <span class="photo media-left"><img alt="avatar" src="assets/backend/images/avatar/1.jpg"></span>
                                ...
                                <a class="dropdown-item media bg-flat-color-4" href="#">
                                    <span class="photo media-left"><img alt="avatar" src="assets/backend/images/avatar/2.jpg"></span>
                                    <span class="message media-body">
                                ...
                                <a class="dropdown-item media bg-flat-color-5" href="#">
                                    <span class="photo media-left"><img alt="avatar" src="assets/backend/images/avatar/3.jpg"></span>
                                    <span class="message media-body">
                                ...
                                <a class="dropdown-item media bg-flat-color-3" href="#">
                                    <span class="photo media-left"><img alt="avatar" src="assets/backend/images/avatar/4.jpg"></span>
                                    <span class="message media-body">
    ...
    <script src="assets/backend/popper.js/dist/umd/popper.min.js"></script>
    <script src="assets/backend/bootstrap/dist/js/bootstrap.min.js"></script>
    <script src="assets/backend/js/main.js"></script>


    <script src="assets/backend/chart.js/dist/Chart.bundle.min.js"></script>
    <script src="assets/backend/js/dashboard.js"></script>
    <script src="assets/backend/js/widgets.js"></script>
    <script src="assets/backend/jqvmap/dist/jquery.vmap.min.js"></script>
    <script src="assets/backend/jqvmap/examples/js/jquery.vmap.sampledata.js"></script>
    <script src="assets/backend/jqvmap/dist/maps/jquery.vmap.world.js"></script>
    <script>
        (function($) {
            "use strict";
