          <div class=" offset-md-1 col-md-11">
            ...
            <form id="form-anggota" method="POST">
              ...
              <div class="form-group row">
                ...
                <div class="col-md-6">
                  <input type="text" id="nama" onkeypress='return harusHuruf(event)' class="form-control" maxlength="64" placeholder="masukan nama anda" name="nama"> <!-- onkeypress='return harusHurufPen(event)' -->
                </div>
              </div>
              <div class="form-group row">
