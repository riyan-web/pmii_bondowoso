...
$query_jenis = "SELECT * FROM `subjeniskonten`
                ...
                WHERE `subjeniskonten`.`nama` = 'berita' ";
...
<div class="modal-header-full-width   modal-header text-center">
  ...
  <div class="modal-body">
    <form id="form-berita" method="POST">
      ...
      <div class="row">
        <div class="col-lg-4">
          <div class="form-group row">
            ...
            <div class="col-lg-9">
              <input type="text" id="judul" onkeypress='return harusHuruf(event)' class="form-control" placeholder="Masukan Judul Berita" name="judul">
            </div>
          </div>
          <div class="form-group row">
            <label class="col-lg-3 control-label">Jenis Berita </label>
            <div class="col-lg-9">
        ...
        <div class="col-lg-8">
          <div class="form-group row">
            <label class="col-lg-1 control-label"><b>Isi Berita</b></label>
            <div class="col-lg-11">
              <textarea class="ckeditor" placeholder="Isi Berita" id="isi" cols="83" name="isi"></textarea>
            </div>
          </div>
        </div>
